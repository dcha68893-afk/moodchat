...
function getDatabaseConfig() {
  ...
  // FIX-DB-CONSISTENT-FALLBACK: this entire module is now only reachable
  // for local/legacy callers — the app's single shared connection lives in
  // models/index.js (see notesService.js, which now imports from there
  // instead of here). No fallback database name is applied; if DB_NAME is
  // unset and no connection string is present, Sequelize will receive
  // `undefined` and fail with a clear "name required" error rather than
