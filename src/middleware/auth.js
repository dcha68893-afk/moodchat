...
// ── Admin-only route guard (P1 FIX: Forensic Audit) ──────────────────────────
// Apply at ROUTER level: router.use('/admin', adminOnly)
// This ensures no future developer accidentally omits the check in a new handler.
