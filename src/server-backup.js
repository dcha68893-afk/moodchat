...
// Mount the main router - auth is already handled by RouterManager's selective auth
this.app.use('/', mainRouter);

console.log('✅ Mounted main API router at /api (routes will be auto-discovered)');
