'use strict';
// PATCHED — this file is a duplicate of 20260118081100createcalls.js
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const __exists = __tables.some(t => String(t).toLowerCase() === 'calls');
    if (__exists) {
      console.log('[Migration] Skipping duplicate migration — Calls table already exists (created by the correctly-named 20260118... migration).');
      return;
    }
    await queryInterface.createTable('Calls', {
      ...
      groupId: {
        ...
        allowNull: true,
        references: {
          model: 'Groups', // FIX: was 'group' (wrong, singular+lowercase), actual table is 'Groups'
          key: 'id'
        },
        onUpdate: 'CASCADE',
        onDelete: 'SET NULL'
