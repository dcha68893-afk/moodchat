'use strict';
// PATCHED — this file is a duplicate of 20260118080700creategroupmembers.js
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const __exists = __tables.some(t => String(t).toLowerCase() === 'groupmembers');
    if (__exists) {
      console.log('[Migration] Skipping duplicate migration — GroupMembers table already exists (created by the correctly-named 20260118... migration).');
      return;
    }
