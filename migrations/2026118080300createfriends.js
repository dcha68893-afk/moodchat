'use strict';
// PATCHED — this file is a duplicate of 20260118080300createfriends.js
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const __exists = __tables.some(t => String(t).toLowerCase() === 'friends');
    if (__exists) {
      console.log('[Migration] Skipping duplicate migration — Friends table already exists (created by the correctly-named 20260118... migration).');
      return;
    }
